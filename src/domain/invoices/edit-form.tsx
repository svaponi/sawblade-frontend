...
import { CustomerField, InvoiceForm } from '@/domain/invoices/definitions';
import { updateInvoice } from '@/domain/invoices/actions';
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              ...
              />
              <CurrencyDollarIcon className="peer-focus: pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2" />
            </div>
          </div>
